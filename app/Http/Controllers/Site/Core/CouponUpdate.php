    ...
    class CouponUpdate extends Controller {
        ...
        public function store(Request $request) {
            ...
            if ($validator->fails()) {
                ...
                if ($request->has("redirect")) {
                    ...
                    return redirect()->route("site.coupon-update.edit", $couponUpdate->id);
                }
            }
        }
        ...
        public function update(Request $request, $id) {
            ...
            if ($validator->fails()) {
                ...
                if ($request->has("redirect")) {
                    ...
                    return redirect()->route("site.coupon-update.edit", $id);
                }
            }
        }
        public function destroy($id) {
            ...
            if (\request()->has("redirect")) {
                ...
                return redirect()->route("site.coupon-update.index")->withInput();
            }
        }
    }
