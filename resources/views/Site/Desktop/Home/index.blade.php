...
@section("section-main")
    ...
    <?php
        ...
        $countPending = Coupon()::whereStatus(EnumProjectStatus::Pending)->count();
        $countWin     = Coupon()::whereStatus(EnumProjectStatus::Win)->count();
        $countLost    = Coupon()::whereStatus(EnumProjectStatus::Lost)->count();
    ?>
