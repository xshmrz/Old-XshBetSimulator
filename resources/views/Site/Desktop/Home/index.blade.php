	...
	<main id="main-container">
		<div class="bg-body-light border-bottom">
			<div class="content py-2 d-flex justify-content-between align-items-center">
				...
				<div>
					<div class="text-end fw-bold">{{number_format($totalSpent,2)}} TL -</div>
					<div class="text-end fw-bold">{{number_format($totalWin,2)}} TL +</div>
					<div class="text-end fw-bold">{{number_format($totalPending,2)}} TL ?</div>
				</div>
			</div>
		</div>
